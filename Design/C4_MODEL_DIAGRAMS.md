# 🏛️ C4 Model - ElectroShop E-Commerce System
...
- **Level 4: Code** - Chi tiết code (Class diagram)

---

## 🔷 Level 1: System Context Diagram

### Sơ đồ bối cảnh hệ thống - Mô tả hệ thống tương tác với người dùng và hệ thống bên ngoài
...
└─────────────────────────────────────────────────────────────────────────────────────┘
    ...
    │             │              │             │              │             │
    │ VNPay/Momo  │              │ SMTP Server │              │ Twilio/etc  │
    │             │              │             │              │             │
    └─────────────┘              └─────────────┘              └─────────────┘
```
...
### Sơ đồ các container - Mô tả các ứng dụng/dịch vụ trong hệ thống
...
│  │   │   │  Web Server  │ │  App Server  │ │   Worker     │ │ Manager  │  │    │  │
│  │   │   └──────────────┘ └──────────────┘ └──────────────┘ └──────────┘  │    │  │
│  │   │                                                                      │    │  │
│  │   │   Modules:                                                           │    │  │
│  │   │   • Catalog Module (Sản phẩm, Danh mục)                             │    │  │
│  │   │   • Order Module (Đơn hàng, Giỏ hàng)                               │    │  │
│  │   │   • User Module (Người dùng, Xác thực)                              │    │  │
...
│  │   │    [Container: MySQL 8.0]      │      │    [Container: Redis 7]        │ │  │
│  │   │        Port: 3308              │      │        Port: 6380              │ │  │
│  │   │                                │      │                                │ │  │
│  │   │  Lưu trữ:                      │      │  Chức năng:                    │ │  │
│  │   │  • Users                       │      │  • Session storage             │ │  │
│  │   │  • Products                    │      │  • Query caching               │ │  │
│  │   │  • Categories                  │      │  • Job queues                  │ │  │
...
│  │   ┌────────────────────────────────┐      ┌────────────────────────────────┐ │  │
│  │   │                                │      │                                │ │  │
│  │   │      DATABASE GUI              │      │        CACHE GUI               │ │  │
│  │   │  [Container: phpMyAdmin]       │      │  [Container: Redis Commander]  │ │  │
│  │   │       Port: 8083               │      │       Port: 8082               │ │  │
│  │   │                                │      │                                │ │  │
│  │   └────────────────────────────────┘      └────────────────────────────────┘ │  │
│  │                                                                               │  │
...
### Sơ đồ các component trong Web Application
...
│  │                                                                              │   │
│  │   ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐   │   │
│  │   │    Views     │  │  Controllers │  │  Middleware  │  │   Routes     │   │   │
│  │   │   (Blade)    │  │              │  │              │  │              │   │   │
│  │   │              │  │ • Home       │  │ • Auth       │  │ • web.php    │   │   │
│  │   │ • home/      │  │ • Product    │  │ • CORS       │  │ • api.php    │   │   │
│  │   │ • product/   │  │ • Category   │  │ • Throttle   │  │ • admin.php  │   │   │
│  │   │ • cart/      │  │ • Cart       │  │ • Admin      │  │              │   │   │
│  │   │ • admin/     │  │ • Order      │  │              │  │              │   │   │
│  │   │              │  │ • User       │  │              │  │              │   │   │
│  │   └──────────────┘  └──────┬───────┘  └──────────────┘  └──────────────┘   │   │
...
│  │   │              │  │              │  │              │  │              │   │   │
│  │   │ • Cart       │  │ • OrderEvent │  │ • SendEmail  │  │ • SendMail   │   │   │
│  │   │ • Payment    │  │ • UserEvent  │  │ • UpdateStock│  │ • ProcessPay │   │   │
│  │   │ • Notify     │  │ • PaymentEvt │  │ • LogActivity│  │ • SyncData   │   │   │
│  │   │              │  │              │  │              │  │              │   │   │
│  │   └──────┬───────┘  └──────────────┘  └──────────────┘  └──────────────┘   │   │
│  │          │                                                                  │   │
│  └──────────┼──────────────────────────────────────────────────────────────────┘   │
...
│  │                                                                              │   │
│  │   ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐   │   │
│  │   │    Models    │  │ Repositories │  │   Eloquent   │  │    Cache     │   │   │
│  │   │              │  │  (Optional)  │  │    ORM       │  │   Facade     │   │   │
│  │   │ • Product    │  │              │  │              │  │              │   │   │
│  │   │ • Category   │  │ • ProductRepo│  │ • HasMany    │  │ • remember() │   │   │
│  │   │ • Order      │  │ • OrderRepo  │  │ • BelongsTo  │  │ • forget()   │   │   │
│  │   │ • User       │  │ • UserRepo   │  │ • HasOne     │  │ • put()      │   │   │
│  │   │ • Cart       │  │              │  │              │  │              │   │   │
│  │   │ • Rating     │  │              │  │              │  │              │   │   │
│  │   └──────┬───────┘  └──────────────┘  └──────────────┘  └──────┬───────┘   │   │
│  │          │                                                      │          │   │
...
├─────────────────────────────────┤      ├─────────────────────────────────┤
│ + checkout(): View              │      │ + index(): View                  │
│ + store(Request): Redirect      │      │ + add(Request): JsonResponse     │
│ + show(int $id): View           │      │ + update(Request): JsonResponse  │
│ + history(): View               │      │ + remove(int $id): JsonResponse  │
└────────────────┬────────────────┘      └────────────────┬────────────────┘
                 │                                         │
                 └──────────────────┬──────────────────────┘
                                    │ uses
...
### Mapping C4 với Docker Containers
