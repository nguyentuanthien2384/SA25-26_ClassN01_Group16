                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 mb-30">
                                    <div class="p-card">
                                        ...
                                        <a href="<?php echo e(route('get.detail.product',[$product->pro_slug,$product->id])); ?>">
                                            <img src="<?php echo e($product->pro_image ? (strpos($product->pro_image, 'http') === 0 ? $product->pro_image : asset($product->pro_image)) : asset('upload/no-image.jpg')); ?>" alt="<?php echo e($product->pro_name); ?>" class="p-img"/>
                                        </a>
                                        <div class="p-title">
