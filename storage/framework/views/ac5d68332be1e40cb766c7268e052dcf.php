                    ...
                    <div class="pay-card__body">
                        <div class="pay-order-info">
                            ...
                            <div class="pay-order-info__row pay-order-info__row--total">
                                ...
                                <strong><?php echo e(number_format($transaction->tr_total)); ?>đ</strong>
                            </div>
                        </div>

                        <?php if(session('danger')): ?>
                            <div class="pay-alert pay-alert--error">
                                <i class="zmdi zmdi-alert-circle"></i> <?php echo e(session('danger')); ?>

                            </div>
                        <?php endif; ?>
                        <?php if(session('warning')): ?>
                            <div class="pay-alert pay-alert--warning">
                                <i class="zmdi zmdi-alert-triangle"></i> <?php echo e(session('warning')); ?>
                        ...
                        <?php if($method === 'qrcode'): ?>
                            ...
                            <div class="qr-bank-info">
                                <div class="qr-bank-info__row">
                                    <span>Ngân hàng</span>
                                    <strong><?php echo e($qrBank); ?></strong>
                                </div>
                                <div class="qr-bank-info__row">
                                    <span>Số tài khoản</span>
                                    <strong><?php echo e($qrAccount); ?></strong>
                                </div>
                                <div class="qr-bank-info__row">
                                    <span>Chủ tài khoản</span>
                                    <strong><?php echo e($qrName); ?></strong>
                                </div>
                                <div class="qr-bank-info__row">
                                    <span>Nội dung CK</span>
                                    <strong>DH<?php echo e($transaction->id); ?></strong>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="qr-image-wrap">
                                <img src="<?php echo e($qrUrl); ?>" alt="QR Code" class="qr-image">
                                <p class="qr-hint">Mở app ngân hàng &rarr; Quét mã QR &rarr; Xác nhận thanh toán</p>
                            </div>
                            <?php endif; ?>

                            <form method="POST" action="<?php echo e(route('payment.qrcode.confirm', ['transaction' => $transaction->id])); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="pay-gateway-info">
                                ...
                                <?php elseif($method === 'paypal'): ?>
                                    ...
                                    <p class="pay-exchange">
                                        Tỷ giá: <?php echo e(number_format($transaction->tr_total)); ?>đ
                                        &asymp; $<?php echo e(number_format($transaction->tr_total / 24000, 2)); ?> USD
                                    </p>
                                <?php endif; ?>
                            </div>

                            <form method="POST" action="<?php echo e(route('payment.init', ['method' => $method, 'transaction' => $transaction->id])); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn-pay">
                                    <i class="zmdi zmdi-lock"></i> Thanh toán <?php echo e(number_format($transaction->tr_total)); ?>đ
                                </button>
                            </form>
                        <?php endif; ?>

                        <a href="<?php echo e(route('home')); ?>" class="pay-back">
