...
<div class="checkout-area pt-80 pb-80">
    <div class="container">
        ...
        <form action="<?php echo e(url('oder/pay')); ?>" method="POST" id="checkout-form">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="checkout-card checkout-card--summary">
                        ...
                        <div class="order-items">
                            ...
                            <div class="order-item">
                                <div class="order-item__img">
                                    <img src="<?php echo e($cart->image ? (strpos($cart->image, 'http') === 0 ? $cart->image : asset($cart->image)) : asset('upload/no-image.jpg')); ?>" alt="<?php echo e($cart->name); ?>">
                                    <span class="order-item__qty"><?php echo e($cart->quantity); ?></span>
                                </div>
                                <div class="order-item__info">
                                    <p class="order-item__name"><?php echo e($cart->name); ?></p>
                                    <p class="order-item__price"><?php echo e(number_format($cart->price)); ?>đ x <?php echo e($cart->quantity); ?></p>
                                </div>
                                <div class="order-item__total">
                                    <?php echo e(number_format($cart->quantity * $cart->price)); ?>đ
                                </div>
                            </div>
                        ...
                        <div class="order-summary">
                            <div class="order-summary__row">
                                <span>Tạm tính (<?php echo e($tong); ?> sản phẩm)</span>
                                <span><?php echo e(number_format($sum)); ?>đ</span>
                            </div>
                            <div class="order-summary__row">
                                <span>VAT (10%)</span>
                                <span><?php echo e(number_format($sum_vat)); ?>đ</span>
                            </div>
                            <div class="order-summary__row">
                            ...
                            <div class="order-summary__row order-summary__row--total">
                                ...
                                <span class="order-total-price"><?php echo e(number_format($sum + $sum_vat)); ?>đ</span>
                            </div>
                        </div>
