                ...
                <div class="col-lg-12">
                    <div class="single-product clearfix">
                         <div class="single-pro-slider single-big-photo view-lightbox slider-for" style="width:55%;height:460px">
                            <div>
                                <img src="<?php echo e($productDetails->pro_image ? (strpos($productDetails->pro_image, 'http') === 0 ? $productDetails->pro_image : asset($productDetails->pro_image)) : asset('upload/no-image.jpg')); ?>" alt="<?php echo e($productDetails->pro_name); ?>" style="width:auto;height:450px" />
                                <a class="view-full-screen" href="<?php echo e($productDetails->pro_image ? (strpos($productDetails->pro_image, 'http') === 0 ? $productDetails->pro_image : asset($productDetails->pro_image)) : asset('upload/no-image.jpg')); ?>"
                        ...
                        <div class="product-info"style="width:45%;height:460px">
                            ...
                            <div class="single-pro-slider single-sml-photo slider-nav">
                                    <div>
                                        <img src="<?php echo e($productDetails->pro_image ? (strpos($productDetails->pro_image, 'http') === 0 ? $productDetails->pro_image : asset($productDetails->pro_image)) : asset('upload/no-image.jpg')); ?>" alt="<?php echo e($productDetails->pro_name); ?>" style="width:105px;height:80px" />
                                    </div>
                                <?php $__currentLoopData = $productimg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
