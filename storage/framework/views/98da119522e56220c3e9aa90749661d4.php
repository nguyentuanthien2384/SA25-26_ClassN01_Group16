        ...
        <div class="container">
            ...
            <div class="pd-wrap">
                <div class="pd-gallery">
                    <img
                        id="mainImage"
                        class="main-img"
                        src="<?php echo e($productDetails->pro_image ? (strpos($productDetails->pro_image, 'http') === 0 ? $productDetails->pro_image : asset($productDetails->pro_image)) : asset('upload/no-image.jpg')); ?>"
                        alt="<?php echo e($productDetails->pro_name); ?>"
                    />
                    <div class="thumb-list">
                        ...
                        <img
                            src="<?php echo e(asset('upload/' . $img->img_product)); ?>"
                            alt=""
                            onclick="changeImage(this)"
                        />
                ...
                <div class="pd-info">
                    <h1 class="pd-name"><?php echo e($productDetails->pro_name); ?></h1>
                    ...
                    <div class="pd-rating">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            ...
                            <?php endif; ?>
                        <?php endfor; ?>
                        <span><?php echo e($avgRating); ?> (<?php echo e($totalReviews); ?> đánh giá)</span>
                    </div>

                    <div class="pd-price-wrap">
                        <?php if($productDetails->pro_sale > 0 && $productDetails->pro_sale < $productDetails->pro_price): ?>
                            <span class="pd-price"><?php echo e(number_format($productDetails->pro_sale, 0, ',', '.')); ?>đ</span>
                            <span class="pd-price-old"><?php echo e(number_format($productDetails->pro_price, 0, ',', '.')); ?>đ</span>
                        <?php else: ?>
                            <span class="pd-price"><?php echo e(number_format($productDetails->pro_price, 0, ',', '.')); ?>đ</span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="pd-stock">
                        Kho: <strong><?php echo e($productDetails->quantity > 0 ? $productDetails->quantity . ' sản phẩm' : 'Tạm hết hàng'); ?></strong>
                    </div>

                    <div class="pd-actions">
                        <a href="<?php echo e(route('cart.add', $productDetails->id)); ?>" class="btn-cart">
                            <i class="zmdi zmdi-shopping-cart-plus"></i> Thêm vào giỏ
                        </a>
                        <a href="<?php echo e(route('cart.add', ['product' => $productDetails->id, 'buy_now' => 1])); ?>" class="btn-buy">
            ...
            <div class="pd-tabs">
                <div class="tab-nav">
                    ...
                    <button onclick="switchTab(event, 'tab-reviews')">Đánh giá (<?php echo e($totalReviews); ?>)</button>
                </div>
                ...
                <div id="tab-reviews" class="tab-panel">
                    ...
                    <ul class="review-list">
                        ...
                        <li class="review-item">
                            <div class="review-avatar">
                                <?php echo e(strtoupper(substr(optional($rating->user)->name ?? 'U', 0, 1))); ?>

                            </div>
                            <div class="review-body">
                                <div class="review-header">
                                    <span class="review-name"><?php echo e(optional($rating->user)->name ?? 'Ẩn danh'); ?></span>
                                    <span class="review-date"><?php echo e($rating->created_at->diffForHumans()); ?></span>
                                </div>
                                <p class="review-text"><?php echo e($rating->ra_content); ?></p>
                            </div>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    ...
                    <div class="review-form">
                        ...
                        <form action="<?php echo e(route('postRating', $productDetails)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="ra_product_id" value="<?php echo e($productDetails->id); ?>">
